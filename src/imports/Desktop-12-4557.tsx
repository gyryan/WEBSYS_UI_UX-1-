...
function DesktopHelper({ additionalClassNames = "" }: DesktopHelperProps) {
  return (
    <div className={clsx("absolute bottom-[114px] flex items-center justify-center top-[359px] w-0", additionalClassNames)}>
      <div className="flex-none h-px rotate-90 w-[1311px]">
        <div className="relative size-full">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1311 1">
              <line id="Line 2" stroke="var(--stroke-0, black)" x2="1311" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
      </div>
...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop">
      ...
      <div className="absolute h-[1664px] right-[19px] top-[40px] w-[1285px]">
      ...
      <div className="absolute bg-[#d9d9d9] h-[1316px] right-[33px] top-[354px] w-[1237px]" />
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] left-[968px] not-italic text-[48px] text-black top-[249.5px] w-[534px]">
        <p className="leading-[1.4]">GRADES</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] left-[523px] not-italic text-[36px] text-black top-[402.5px] w-[534px]">
        <p className="leading-[1.4]">Course</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] left-[750px] not-italic text-[36px] text-black top-[402.5px] w-[534px]">
        <p className="leading-[1.4]">Time</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] left-[970px] not-italic text-[36px] text-black top-[402.5px] w-[534px]">
        <p className="leading-[1.4]">Grades</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] not-italic right-[527px] text-[36px] text-black top-[402.5px] translate-x-full w-[534px]">
        <p className="leading-[1.4]">Status</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] not-italic right-[262px] text-[36px] text-black top-[402.5px] translate-x-full w-[534px]">
        <p className="leading-[1.4]">Professor</p>
      </div>
      <DesktopHelper additionalClassNames="left-[694px]" />
      <DesktopHelper additionalClassNames="left-[917px]" />
      <DesktopHelper additionalClassNames="left-[1140px]" />
      <DesktopHelper additionalClassNames="left-[1363px]" />
      <div className="absolute h-0 right-[19px] top-[432px] w-[1251px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1251 1">
            <line id="Line 6" stroke="var(--stroke-0, black)" x2="1251" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
