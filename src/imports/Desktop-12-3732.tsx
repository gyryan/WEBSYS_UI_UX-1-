...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop">
      ...
      <div className="absolute bg-[#d9d9d9] bottom-[-5px] right-[-18px] top-[-9px] w-[1346px]" />
      ...
      <div className="absolute h-[1670px] right-[19px] top-[40px] w-[1285px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1285 1670">
          <path d={svgPaths.p3ff1a900} fill="var(--fill-0, white)" id="Rectangle 38" />
        </svg>
      </div>
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Alike_Angular:Regular',sans-serif] h-[59px] justify-center leading-[0] left-[854px] not-italic text-[48px] text-black top-[292.5px] w-[534px]">
        <p className="leading-[1.4]">REGISTRATION FORM</p>
      </div>
      <div className="absolute bg-[#d9d9d9] h-[1104px] right-[50px] rounded-[24px] top-[514px] w-[1205px]" />
